@extends('layouts.crud.edit', [
    'title' => 'Alterar Template de Msg',
    'route' => route('whatsapp_template.update', $whatsappTemplate->id),
...
<div class="form-group">
    <div class="row">
        @component('components.input-text', [
                ...
                'label' => 'Template',
                'inputSize' => 10,
                'inputValue' => $whatsappTemplate->template_name
            ])
        @endcomponent
...
@component('components.form-group', [
    'inputs' => [
        [
            ...
            'required' => true,
            'inputSize' => 12,
            'inputValue' => $whatsappTemplate->template_content
        ]
    ]
])
@endcomponent
