                  ...
                  <div class="card rounded-0 mb-0 px-2">
                      <div class="card-header pb-1">
                          <div class="card-title">
                              <h4 class="mb-0">Reconfigurar Senha</h4>
                          </div>
                      </div>
                      <p class="px-2">Informe uma nova senha.</p>
                              ...
                              <input type="hidden" name="token" value="{{ $token }}">
                                ...
                                <div class="row pt-2">
                                    <div class="col-12 col-md-6 mb-1">
                                        <a href="{{ route('admin.login') }}" class="btn btn-outline-primary btn-block px-0">Voltar ao Login</a>
                                    </div>
                                    <div class="col-12 col-md-6 mb-1">
                                        <button type="submit" class="btn btn-primary btn-block px-0">Recuperar</button>
                                    </div>
                                </div>
                            </form>
                          </div>
