            ...
            <div class="row mt-1">
                <div class="col">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="send-billet" v-model="options.send_billet">
                        <label class="custom-control-label" for="send-billet">Enviar Boleto em PDF</label>
                    </div>
                </div>
            </div>
        </div>
