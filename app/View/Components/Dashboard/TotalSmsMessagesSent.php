...
class TotalSmsMessagesSent extends Component
{
    ...
    {
        return view('components.dashboard.total-sms-messages-sent');
    }

    private function getSmssSent() {
        $startDate = Carbon::today()->subDays(7);
        $endDate = Carbon::today();
        while ($startDate <= $endDate) {
            $totalOfDay = $this->getSmssSentByDay(new CarbonImmutable($startDate));
